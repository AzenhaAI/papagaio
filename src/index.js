...
const UNIT_ORDER = {
  pt: [
    ...
    { key: 'adjetivos',  label: '🎨 Describing things' },
    { key: 'familia',    label: '👨‍👩‍👧 People' },
    { key: 'casa',       label: '🏠 Home' },
    { key: 'corpo',      label: '🫀 Body & health' },
    { key: 'roupa',      label: '👕 Clothes' },
    { key: 'natureza',   label: '🌿 Nature & weather' },
    { key: 'cidade',     label: '🏙 City' },
    { key: 'lugar',      label: '📍 Places & getting around' },
    { key: 'sentimentos', label: '💭 Feelings & abstract' },
    { key: 'adverbios',  label: '🧭 Adverbs & connectors' },
